...
<section class="content-header aksi">
	<?php echo anchor(@$link_add, 'Tambah Staf');?>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
			<div class="row">
				<div class="col-xs-12">
					<b class="title-section">Head Coach</b>
				</div>
				<div class="col-xs-12">
					<div class="row">
						<hr>
		    ...
		    <div class="row">
		        <div class="col-sm-4 col-md-3 col-lg-2">
		        	<div class="pengurus-wrapper">
		        		<div class="photo" style="background-image: url('<?php echo base_url("{$hc['photo']}") ?>')"></div>
						<div class="info">
							<p class="name">
								<?php echo $hc['nama'] ?>
							</p>
						...
						<div class="aksi">
							<div class="btn-group btn-group-justified">
								<a href="<?php echo base_url('pengurus/head_coach') ?>" class="btn btn-default btn-ubah">Ubah</a>
							</div>
						</div>
		        	</div>
		        </div>
	...
	<div class="row">
		<div class="col-xs-12">
		    ...
		    <div class="row list-staf">
				<?php foreach ($staf as $data): ?>
					<?php 
					$photo = empty($data->photo) ? "assets/themes/adminLTE/img/boxed-bg.png" : "{$ImageUploadPath}thumb/$data->photo"
					?>
					<div class="col-sm-4 col-md-3 col-lg-2 data-pengurus-<?php echo $data->id_pengurus ?>" style="margin-bottom: 15px">
						<div class="pengurus-wrapper">
							...
							<div class="aksi">
								<div class="btn-group btn-group-justified">
									<a href="<?php echo base_url("pengurus/edit/$data->id_pengurus") ?>" class="btn btn-default btn-ubah">Ubah</a>
									<a href="#" class="btn btn-default btn-hapus" data-id="<?php echo $data->id_pengurus ?>">Hapus</a>
								</div>
							</div>
			        	</div>
			        </div>
...
<script>
	$(document).ready(function() {
        ...
        $('.mn-Pengurus, .mn-Pengurus .mn-Data').addClass('active');
