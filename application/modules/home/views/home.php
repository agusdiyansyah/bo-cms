	        ...
	        <section id="tm-bottom-a" class="tm-bottom-a uk-grid uk-grid-collapse" data-uk-grid-match="{target:'> div > .uk-panel'}" data-uk-grid-margin="">
	            <div class="uk-width-1-1">
	                <div class="uk-panel tt-achievments-wrap">
	                    <div class="uk-grid uk-grid-collapse">
	                        <div class="uk-width-large-12 uk-width-medium-12 achievments-block">
	                                ...
	                                <div class="uk-slidenav-position our-awards" data-uk-slider="{autoplay:true, autoplayInterval:7000}">
	                                    ...
	                                    <div class="uk-slider-container">
	                                        <ul class="uk-slider uk-grid uk-grid-width-large-1-2">
	                                        	<?php foreach ($trophy as $t): ?>
		                                            <li>
		                                            	<?php 
		                                            	$t_image = ($t->photo == "") ? "trophy_default.png" : $t->photo ;
		                                            	?>
		                                                <div class="img-wrap">
		                                                	<img draggable="false" src="<?php echo base_url().'assets/upload/images/trophy/thumb/'.$t_image;?>" height="150px" >
		                                                </div>
		                                                <div class="text"><?php echo $t->tahun." ".$t->nama_trophy;?></div>
		                                            </li>
	                                        	<?php endforeach ?>
	                                        </ul>
	                                    </div>
